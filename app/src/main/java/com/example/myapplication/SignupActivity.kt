...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val newusernameEditText = findViewById<EditText>(R.id.new_username_edit_text)
            ...
            val stringRequest = object : StringRequest(
                ...
                Response.Listener { response ->
                    ...
                    when (response) {
                        ...
                        "0" -> {
                            Toast.makeText(this, "Login successful! Please Scan QR Code", Toast.LENGTH_SHORT).show()
                            ...
                            Toast.makeText(this, "Login successful! Please go to No. $response", Toast.LENGTH_SHORT).show()
            ...
            val request = object : StringRequest(
                ...
                Response.Listener { response ->
                    when (response) {
                        ...
                        "1" -> {
                            Toast.makeText(this, "Username and Password is already registered. Please Login Instead", Toast.LENGTH_LONG).show()
                        }
                        else -> {
